...
----
    ...
    # 只下载指定模型
    python scripts/download_pretrained.py --models RealESRGAN_x4plus BSRGAN

    # 使用代理
    python scripts/download_pretrained.py --proxy http://127.0.0.1:7890
"""
...
def main():
    ...
    if fail > 0:
        print(f'\n提示: 如果 GitHub 下载慢，可以：')
        print(f'  1. 使用代理: python scripts/download_pretrained.py --proxy http://127.0.0.1:7890')
